...
Java_com_example_fonline_NativeBridge_nativeInit(JNIEnv* env, jclass, jobject assets, jstring filesDirPath)
{
    std::lock_guard<std::mutex> lk(gMutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnSurfaceCreated(JNIEnv* env, jclass, jobject surface)
{
    std::lock_guard<std::mutex> lk(gMutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnSurfaceChanged(JNIEnv*, jclass, jint width, jint height)
{
    std::lock_guard<std::mutex> lk(gMutex);
    gW = width;
    gH = height;
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnSurfaceDestroyed(JNIEnv*, jclass)
{
    std::lock_guard<std::mutex> lk(gMutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnResume(JNIEnv*, jclass)
{
    std::lock_guard<std::mutex> lk(gMutex);
    LOGI("nativeOnResume");
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnPause(JNIEnv*, jclass)
{
    std::lock_guard<std::mutex> lk(gMutex);
    LOGI("nativeOnPause");
    stopRenderThreadLocked();
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeShutdown(JNIEnv* env, jclass)
{
    std::lock_guard<std::mutex> lk(gMutex);
    LOGI("nativeShutdown");
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_fonline_NativeBridge_nativeOnTouch(JNIEnv*, jclass,
